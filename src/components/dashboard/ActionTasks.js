const tasks = [
  ...
  { status: '심사 대기', tone: 'green', description: '미처리 한도 심사 건이 12건 있습니다.' },
  { status: '재고 부족', tone: 'orange', description: '재고 부족 상품이 3건 있습니다.' },
  { status: '상환 지연', tone: 'red', description: 'D+1 연체 발생 건이 5건 있습니다.' },
];
  ...
  return (
    <section className="panel task-panel">
      ...
      <ul className="task-list">
        {tasks.map((task) => (
          <li className="task-list__item" key={task.status}>
